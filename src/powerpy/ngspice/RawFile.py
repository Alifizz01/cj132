...
class Variable(VariableAbc):
    ...
    def 1s_voltage_node(self):  # OCR_UNCLEAR: likely 'is_voltage_node' duplicate or different name
...
class RawFile(RawFileAbc):
    ...
    def _read_header(self, stdout):
        ...
        self._read_header_field_line(header_line_iterator, 'No. Points', has_value=False)
